...
public class FileUtils
{
    ...
    public static DownloadStatus downloadFile(String savePath, String fileUrl,String name, boolean downNew) {
        URL urlfile = null;
        ...
        try {
            ...
            fileName =name==null? urlPath.substring(urlPath.lastIndexOf("/") + 1):name;
